 ...
 * 
 */
public class New_Step2 {
	public static class New_Step2_Mapper extends
	...
	public static class New_Step2_Reducer extends
	...
	public static void main(String[] args) throws Exception {
		...
		String[] ars = new String[] {
				"hdfs://192.168.192.100:9000/user/root/output_examnewstep1",
		...
		job.setJarByClass(New_Step2.class);
		job.setMapperClass(New_Step2_Mapper.class);
//		job.setCombinerClass(Step2_Reducer.class);
		job.setReducerClass(New_Step2_Reducer.class);
