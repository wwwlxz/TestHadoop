 ...
 * 
 */
public class New_Step1 {
	public static class New_Step1_Mapper extends
	...
	public static class New_Step1_Reducer extends
...
//				ItemScores.set(val.toString() + ",");
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(New_Step1.class);
		job.setMapperClass(New_Step1_Mapper.class);
//		job.setCombinerClass(Step1_Reducer.class);
		job.setReducerClass(New_Step1_Reducer.class);
